...
int CRT_colorSchemes[LAST_COLORSCHEME][LAST_COLORELEMENT] = {
   [COLORSCHEME_DEFAULT] = {
      ...
      [MEMORY_UNCOMPRESSED] = ColorPair(Green,Black),
      [MEMORY_COMPRESSED] = ColorPair(Magenta,Black),
      [MEMORY_BUFFERS] = ColorPair(Blue,Black),
      [MEMORY_BUFFERS_TEXT] = A_BOLD | ColorPair(Blue,Black),
      [MEMORY_CACHE] = ColorPair(Yellow,Black),
      [ZRAM_UNCOMPRESSED] = ColorPair(Green,Black),
      [ZRAM_COMPRESSED] = ColorPair(Magenta,Black),
   ...
   [COLORSCHEME_BLACKONWHITE] = {
      ...
      [MEMORY_UNCOMPRESSED] = ColorPair(Green,White),
      [MEMORY_COMPRESSED] = ColorPair(Magenta,White),
      [MEMORY_BUFFERS] = ColorPair(Cyan,White),
      [MEMORY_BUFFERS_TEXT] = ColorPair(Cyan,White),
      [MEMORY_CACHE] = ColorPair(Yellow,White),
      [ZRAM_UNCOMPRESSED] = ColorPair(Green,White),
      [ZRAM_COMPRESSED] = ColorPair(Magenta,White),
   ...
   [COLORSCHEME_MIDNIGHT] = {
      ...
      [MEMORY_UNCOMPRESSED] = A_BOLD | ColorPair(Green,Blue),
      [MEMORY_COMPRESSED] = ColorPair(White,Blue),
      ...
      [ZRAM_UNCOMPRESSED] = A_BOLD | ColorPair(Green,Blue),
      [ZRAM_COMPRESSED] = ColorPair(White,Blue),
